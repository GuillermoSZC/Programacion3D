...
void Shader::SetupAttribs() const
{
    if (location != -1)
    {
        ...
        (
            ...
            reinterpret_cast<const void*>(offsetof(Vertex, vertexPosition))
        );
    }
    ...
    if (colorLoc != -1)
    {
        ...
        glVertexAttribPointer
        (
            colorLoc, 3, GL_FLOAT, false, sizeof(Vertex),
            reinterpret_cast<const void*>(offsetof(Vertex, vertexColor))
        );
    }
}
